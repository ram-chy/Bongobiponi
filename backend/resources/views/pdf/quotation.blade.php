...
<head>
    <meta charset="utf-8">
    <title>Quotation {{ $quotation->quotation_serial }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="header">
        <h1>QUOTATION</h1>
        <p>{{ $quotation->quotation_serial }}</p>
    </div>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value">{{ $quotation->creator->first_name }} {{ $quotation->creator->last_name }}</td>
        </tr>
    </table>
    ...
    <div class="customer-details">
        ...
        @endif
        <p>{{ $quotation->customer->billing_address }}</p>
        <p>{{ $quotation->customer->city }}, {{ $quotation->customer->state }} - {{ $quotation->customer->postal_code }}</p>
