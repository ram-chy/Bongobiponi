...
export function DamageEntryPage() {
  ...
  const mutation = useMutation({
    mutationFn: (data: Record<string, unknown>) =>
      inventoryService.createDamage(data),
    onSuccess: () => {
  ...
  return (
    <div>
      <PageBreadcrumb
        items={[
          { label: "Inventory" },
          { label: "Damage Entry", href: "/inventory/damage" },
          { label: "Create" },
        ]}
      />
      <PageHeader title="Damage Entry" description="Record damaged stock." />
